...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView lostPassword = (TextView) findViewById(R.id.lost_password);
        ...
        TextView signInLink = (TextView) findViewById(R.id.sign_in);
    ...
    private void reAskPassword() {
        Intent i = new Intent(LoginActivity.this, LostPassword.class);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            u = ul.check(mUsername,mPassword);
            if (u != null) {
                return true;
            }
            return false;
